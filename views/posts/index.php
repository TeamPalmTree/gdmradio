<div class="container">
        ...
        <div class="gdmradio-section-content">
            <div class="media">
                ...
                <div class="media-body">
                    <a class="gdmradio-media-title-link" href="/posts/view/<?php echo $post->id; ?>"><?php echo $post->title; ?></a>
    ...
    <?php endforeach; ?>
    <ul class="pager">
        <li class="previous"><a href="/posts/page/<?php echo $page + 1; ?>">&larr; Older</a></li>
        <?php if ($page == 1): ?>
        <li class="next disabled"><a>Newer &rarr;</a></li>
        <?php else: ?>
        <li class="next"><a href="/posts/page/<?php echo $page - 1; ?>">Newer &rarr;</a></li>
        <?php endif; ?>
    </ul>
</div>